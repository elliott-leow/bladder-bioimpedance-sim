...
Replicates and extends the EIDORS-based MATLAB simulation using pure
Python (numpy/scipy/matplotlib).

Physics: Complete Electrode Model (CEM) on tetrahedral FEM mesh.
Tissue data: Gabriel et al. 1996 + IT'IS Foundation database.
...
model             : Anatomical pelvis model construction
...
from .model import build_pelvis_model, get_bladder_mask
